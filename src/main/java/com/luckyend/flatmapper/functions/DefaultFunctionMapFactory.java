 ...
 */
@NoArgsConstructor
public class DefaultFunctionMapFactory implements FunctionMapFactory<Object> {
	
	private static FunctionMapFactory<Object> INSTANCE = null;
	...
	public static FunctionMapFactory<Object> getDefaultInstance() {
        if (INSTANCE == null){
